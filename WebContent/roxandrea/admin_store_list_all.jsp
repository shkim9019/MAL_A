<%--
  ...
  *   수정일                                         수정자                      수정내용
  *  -------                  --------    ---------------------------
  *  2020. 3. 10. 오전 11:21:56   sist         최초 생성
  *
  * author 쌍용교육센터 E반
  * since 2009.01.06
  *
...
<%
	...
	List<StoreVO> memberList = (List<StoreVO>)request.getAttribute("storeList");
	/*
	for(BoardVO vo :list) {
		//out.print(vo+"<br>");
	}
...
<body>
			...
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          		<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          			<div class="text">
	            		...
	            		<h1 class="mb-4 bread">STORE MANAGEMENT</h1>
            		</div>
          		</div>
        	</div>
		</div>
	...
	<section class="ftco-section">
		...
		<form action="/MAL_A/roxandrea/store.do" name="searchFrm" id="searchFrm" method="get">
				...
				<div class="row justify-content-center mb-5 pb-3">
	          		<div class="col-md-12 heading-section text-center ftco-animate">
	          			...
	          			<table class="table table-hover" id="listTable">
							...
							<tbody>
								<c:choose>
									<c:when test="${null!=storeList && storeList.size()>0 }">
										<c:forEach var="vo" items="${storeList }" >
											<tr>
												<td><input type="radio" value="${vo.sno }" name="radioBtn"/></td>
   ...
   function goLandmarkListAll(){
  	...
  	$("#updateStopBtn").on('click', function(){
		...
		radio.each(function(i){
			...
			var tName = td.eq(2).text();
			var tViews = td.eq(7).text();
			var tSno = td.eq(8).text();
