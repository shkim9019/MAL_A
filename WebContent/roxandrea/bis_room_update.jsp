...
<%
	...
	List<RoomOptionVO> outListRoomOption = (List<RoomOptionVO>)request.getAttribute("outListRoomOption");
          ...
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="start.jsp">홈</a></span>
	            							<span class="mr-2"><a href="landmark.jsp">방 수정</a></span></p>
	            <h2 class="mb-4 bread">방 수정</h2>
            </div>
          </div>
        </div>
      </div>
						...
						<div class="col-md-12 room-single mt-4 mb-5 ftco-animate" align="center">
							...
							<div class="d-md-flex mt-5 mb-5" align="center">
								<form name="roomFrm" id="roomFrm" action="<%=HR_PATH %>/roxandrea/room.do" method="post">
									...
									<input type="hidden" name="rno" id="rno" value="${roomVO.rno}"/>
   									...
   									<div id="callBackDiv">
										<table border="1" cellpadding="5" cellspacing="0" width="600">
											<tr>
												...
												<td><input type="text" name="name" id="name" value="${roomVO.name}" size="40" placeholder="최대 30자로 입력하세요." maxlength="30" translate="no"/></td>
											</tr>
											
											<tr>
												<td bgcolor="#E6FFFF">수용 인원</td>
												<td><input type="text" name="capacity" id="capacity" value="${roomVO.capacity}" size="40" placeholder="숫자로만 입력해주세요. ex) 2 or 14..." maxlength="4" translate="no"/></td>
											</tr>	
											
											<tr>
												<td bgcolor="#E6FFFF">설명</td>
												<td><textarea name="cont" id="cont" rows="10" cols="40" placeholder="최대 100자로 입력해주세요." maxlength="100" translate="no">${roomVO.cont}</textarea></td>
											</tr>
											
											<tr>
												<td bgcolor="#E6FFFF">주중가</td>
												<td><input type="text" name="price1" id="price1" value="${roomVO.price1}" size="40" placeholder="숫자로만 입력해주세요. ex) 2 or 14..." maxlength="10" translate="no"/></td>
											</tr>
											
											<tr>
												<td bgcolor="#E6FFFF">주말가</td>
												<td><input type="text" name="price2" id="price2" value="${roomVO.price2}" size="40" placeholder="숫자로만 입력해주세요. ex) 2 or 14..." maxlength="10" translate="no"/></td>
											</tr>
											...
											<div class="d-md-flex mt-10 mb-10 py-5">
												<div class="d-md-flex mt-5 mb-5" align="center">
													<table border="1" cellpadding="5" cellspacing="0" width="600">
														...
														<tbody>
															<c:choose>
																<c:when test="${null!=outListRoomOption && outListRoomOption.size()>0 }">
																	<c:forEach var="roomOptionVO" items="${outListRoomOption }" >
																		<tr>
																			<td>
																				<c:if test="${roomOptionVO.yn eq '1'}">
																					&nbsp;<input type="checkbox" id="roomOption" name="roomOption" value="${roomOptionVO.opt }" checked/>&nbsp;${roomOptionVO.optName }
																				</c:if>
																				<c:if test="${roomOptionVO.yn eq '0'}">
																					&nbsp;<input type="checkbox" id="roomOption" name="roomOption" value="${roomOptionVO.opt }" />&nbsp;${roomOptionVO.optName }
																				</c:if>
																			</td>
																		</tr>
																	</c:forEach>
							...
							<div  class="tagcloud" align="center">
               					<div align="right">
               						<a class="tag-cloud-link" onclick="javascript:doUpdate();">수정</a>
  ...
  <script type="text/javascript">
	...
	function goStoreSelectOne(){
  	...
  	function goRoomList(){
		...
		frm.autho.value = "2";
		frm.searchDiv.value = "1";
		frm.searchWord.value = '${roomVO.sno}';
