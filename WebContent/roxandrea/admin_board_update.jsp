...
<section class="ftco-section ftco-menu" >
 ...
 function goLandmarkListAll(){
    ...
    function goRetrieve2(sq,ss){
        window.location.href='http://localhost:8080/MAL_A/roxandrea/board.do?workDiv=doAdminSelectOne&pageNum=&seq='+sq+'&regId='+ss+'&pageSize=10&searchDiv=&searchWord=';
    }
