          ...
          <div class="col-lg-8">
          	<div class="row">
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<p><input type="button" value="정보수정" onclick="javascript:doUpdate();"/></p>
          			<h2 class="mb-4"><strong>${storeVO.name }</strong><span><strong>&nbsp;&nbsp;평점&nbsp;:&nbsp;${reviewVO.star eq null ? 0 : reviewVO.star }</strong></span></h2>
 ...
 <%@ include file="/cmn/footer.jsp" %>
  ...
  <script type="text/javascript">
	...
	//--예약 내역으로 이동
  	...
  	//정보 수정
  	function doUpdate(){
		//if(false==confirm('정보를 수정 하시겠습니까?'))return;
		
		var frm = document.storeFrm;
		frm.workDiv.value = "doSelectOne";
		frm.fileId.value = "${storeVO.fileId }";
		frm.autho.value = "4";
