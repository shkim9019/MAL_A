...
<%
	List<CodeVO> outListStoOption = (List<CodeVO>)request.getAttribute("outListStoOption");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="#">숙박의민족</a>
			...
			<div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          		<div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          			<div class="text">
	            		...
	            		<h1 class="mb-4 bread">STORE INSERT</h1>
            		</div>
          		</div>
        	</div>
		</div>
			...
			<div class="container">
				<div class="row justify-content-center mb-5 pb-3">
	          		<div class="col-md-7 heading-section text-center ftco-animate">
	          			<span class="subheading">store_insert</span>
	            		<h2>업체 등록</h2>
	            	</div>
	            </div>
			</div>
									...
									<table border="1" cellpadding="5" cellspacing="0" width="600">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<input class="phoneNumber" type="text" name="tel" id="tel" size="40" placeholder="'-'를 빼고 입력하세요." maxlength="13" translate="no"/>
												</td>
											</tr>
											...
											<tr>
												...
												<td><input type="text"  size="40" id="zipNo"  name="zipNo" readonly/>
													<input type="button" value="우편번호 찾기" onclick="goPopup();"/></td>
											</tr>
											<tr>
												<td bgcolor="#E6FFFF">주소</td>	
												<td><input type="text"  size="40" id="roadFullAddr"  name="roadFullAddr" readonly/></td>
											</tr>
											
											<tr>
												<td bgcolor="#E6FFFF">업체 소개</td>
												<td><textarea name="cont"  id="cont" rows="10" cols="60" placeholder="최대 1000자로 입력해주세요." maxlength="1000" translate="no"></textarea></td>
											</tr>
										</tbody>
									</table>
								</div>
											...
											<c:choose>
												<c:when test="${null!=outListStoOption && outListStoOption.size()>0 }">
													<c:forEach var="stoOptionVO" items="${outListStoOption }" >
														<tr>
															<td>
																&nbsp;<input type="checkbox" id="stoOption" name="stoOption" value="${stoOptionVO.dtlId }" />&nbsp;${stoOptionVO.dtlNm }
															</td>
														</tr>
													</c:forEach>
												</c:when>
...
<%@ include file="/cmn/footer.jsp" %>
  ...
  <script type="text/javascript">
	...
	function doInsert(){
		...
		var local = $("#local option:selected").val();//지역번호
		...
		*/
		...
		$.ajax({
			...
			success:function(data){//성공
				alert('등록 성공했습니다.\n다시 로그인 해주세요.');
				window.location.href="/MAL_A/roxandrea/log_in.jsp";
