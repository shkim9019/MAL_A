        ...
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            ...
	            <h1 class="mb-4 bread">USER INFO</h1>
            </div>
          </div>
        </div>
      </div>
	    ...
	    <div id="callBackDiv">
			<table class="table table-bordered" border="1" cellpadding="5" cellspacing="0" width="600">
				...
				<tr>
					...
					<td><input type="text" value="${vo.pw}" name="pw" id="pw" size="20" readonly="readonly"/></td>
				<tr/>	
				<tr>
				...
				<tr>
					...
					<td><input type="text" value="${vo.email}" name="email" id="email" size="20" readonly="readonly"/></td>
				<tr/>
				<tr>
				...
				<tr>
					...
					<td><input type="text" value="${vo.tel}" name="tel" id="tel" size="20" readonly="readonly"/></td>
				<tr/>
				<tr>
					<td bgcolor="#99ccff">사용자 선택</td>					
					<td><input type="text" value="${vo.autho}" size="20" readonly="readonly"/></td>					
				<tr/>
				<tr>
			...
			<input type="button" onclick="location.href='javascript:goMemberUpdate();'"  value="내 정보 수정" id="cancel" />
		</div>
	...
	<table border="0" cellpadding="5" cellspacing="0" width="600">
		<tr>
			<td colspan="2" align="right">
				<div>					
					<input type="button" onclick="location.href='bis_main.jsp'"  value="돌아가기" id="cancel" />
				</div>
			</td>
		</tr>
	</table>
...
<%@ include file="/cmn/footer.jsp" %>
  ...
  <form name="searchFrm2" action="/MAL_A/roxandrea/payment.do" method="post">
	...
	<form name="searchFrm3" action="/MAL_A/roxandrea/member.do" method="post">
    				<input type="hidden" name="workDiv" />
					<input type="hidden" name="pageNum" />
					<input type="hidden" name="regId" />
					<input type="hidden" name="searchDiv" />
  	...
  	<form name="searchFrm4" action="/MAL_A/roxandrea/heart.do" method="post">
    				<input type="hidden" name="workDiv" />
					<input type="hidden" name="pageNum" />
					<input type="hidden" name="regId" />
					<input type="hidden" name="searchDiv" />
